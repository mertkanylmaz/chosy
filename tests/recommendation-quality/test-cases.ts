...
export const TEST_CASES: QualityTestCase[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SPRINT 1 — KATEGORI A: DUYGUSAL NUANS (5 vaka)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'sprint1-a01-rainy-hopeful',
    mood_input: 'yagmurlu bir aksam, huzunlu ama umutlu bir seyler',
    archetype: 'Melancholy Soul',
    taste_profile: {
      emotional_state: emo({ sadness: 0.7, joy: 0.3, trust: 0.5, anticipation: 0.4 }),
      energy_level: 0.25,
      pace_preference: 'slow',
      visual_style: 'cinematic',
      thematic_depth: 0.7,
  ...
  {
    id: 'sprint1-a02-tired-light',
    mood_input: 'yorgun ama film izleyecegim, cok yogun olmasin',
    archetype: 'Zen Wanderer',
    taste_profile: {
      emotional_state: emo({ joy: 0.5, trust: 0.6, sadness: 0.1, fear: 0.0 }),
      energy_level: 0.2,
      pace_preference: 'slow',
      visual_style: 'lush',
      thematic_depth: 0.2,
  ...
  {
    id: 'sprint1-a03-joyful-comedy',
    mood_input: 'neseli, hafif, gulmek istiyorum',
    archetype: 'Joy Seeker',
    taste_profile: {
      emotional_state: emo({ joy: 0.9, trust: 0.6, surprise: 0.4, sadness: 0.0 }),
      energy_level: 0.65,
      pace_preference: 'medium',
      visual_style: 'lush',
      thematic_depth: 0.15,
      ending_preference: 'hopeful',
      era_preference: { from: 1995, to: 2026 },
      cultural_context: [],
      avoid_signals: ['horror', 'war', 'death'],
      narrative_style: 'linear',
      social_context: 'friends',
      rewatch_tolerance: true,
    },
  ...
  {
    id: 'sprint1-a04-anxious-no-horror',
    mood_input: 'kaygili, gerilimli, ama korku filmi olmasin',
    archetype: 'Dark Passenger',
    taste_profile: {
      emotional_state: emo({ fear: 0.65, anticipation: 0.7, anger: 0.3, surprise: 0.5 }),
      energy_level: 0.5,
      pace_preference: 'medium',
      visual_style: 'raw',
      thematic_depth: 0.75,
      ...
      era_preference: { from: 1990, to: 2026 },
      cultural_context: [],
      avoid_signals: ['horror', 'supernatural', 'jump scare'],
      narrative_style: 'linear',
      social_context: 'alone',
      rewatch_tolerance: false,
    },
  ...
  {
    id: 'sprint1-a05-nostalgic-childhood',
    mood_input: 'nostaljik, cocuklugumu hatirlatsin',
    archetype: 'Nostalgia Keeper',
    taste_profile: {
      emotional_state: emo({ trust: 0.8, joy: 0.6, sadness: 0.35, anticipation: 0.3 }),
      energy_level: 0.35,
      pace_preference: 'medium',
      visual_style: 'cinematic',
      thematic_depth: 0.35,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SPRINT 1 — KATEGORI B: TR PAZAR (3 vaka)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'sprint1-b01-nbc-deep',
    mood_input: 'Nuri Bilge Ceylan tarzi, uzun cekimler, derin film',
    archetype: 'Truth Seeker',
    taste_profile: {
      emotional_state: emo({ trust: 0.6, sadness: 0.55, disgust: 0.2, anger: 0.2 }),
      energy_level: 0.1,
      pace_preference: 'slow',
      visual_style: 'minimalist',
      thematic_depth: 0.95,
  ...
  {
    id: 'sprint1-b02-turkish-comedy',
    mood_input: 'Turk komedi, eglenceli ama klise degil',
    archetype: 'Joy Seeker',
    taste_profile: {
      emotional_state: emo({ joy: 0.85, trust: 0.5, surprise: 0.4 }),
      energy_level: 0.7,
      pace_preference: 'medium',
      visual_style: 'cinematic',
      thematic_depth: 0.25,
  ...
  {
    id: 'sprint1-b03-istanbul-melancholic',
    mood_input: 'Istanbul\'da gecen melankolik bir film, yagmurlu',
    archetype: 'Melancholy Soul',
    taste_profile: {
      emotional_state: emo({ sadness: 0.8, trust: 0.4, joy: 0.1, fear: 0.15 }),
      energy_level: 0.15,
      pace_preference: 'slow',
      visual_style: 'raw',
      thematic_depth: 0.85,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SPRINT 1 — KATEGORI C: SINEFIL NIS (3 vaka)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'sprint1-c01-wong-kar-wai',
    mood_input: 'Wong Kar-wai tarzi, gorsel olarak buyuleyici',
    archetype: 'Visual Poet',
    taste_profile: {
      emotional_state: emo({ sadness: 0.6, joy: 0.3, trust: 0.5, anticipation: 0.3 }),
      energy_level: 0.25,
      pace_preference: 'slow',
      visual_style: 'lush',
      thematic_depth: 0.8,
  ...
  {
    id: 'sprint1-c02-tarkovsky',
    mood_input: 'Tarkovsky atmosferi, uzun ve dusundurici',
    archetype: 'Visual Poet',
    taste_profile: {
      emotional_state: emo({ trust: 0.5, sadness: 0.4, fear: 0.3, surprise: 0.2 }),
      energy_level: 0.05,
      pace_preference: 'slow',
      visual_style: 'experimental',
      thematic_depth: 0.95,
      ending_preference: 'open',
      era_preference: { from: 1960, to: 2026 },
      cultural_context: [],
      avoid_signals: [],
      narrative_style: 'nonlinear',
      social_context: 'alone',
  ...
  {
    id: 'sprint1-c03-coen-brothers',
    mood_input: 'Coen Brothers humoru, absurt komedi',
    archetype: 'Chaos Agent',
    taste_profile: {
      emotional_state: emo({ joy: 0.6, surprise: 0.6, anticipation: 0.5, anger: 0.3 }),
      energy_level: 0.6,
      pace_preference: 'medium',
      visual_style: 'cinematic',
      thematic_depth: 0.55,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SPRINT 1 — KATEGORI D: EDGE CASE (4 vaka)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'sprint1-d01-empty-input',
    mood_input: '',
    archetype: 'Escapist',
    taste_profile: {
      emotional_state: emo({ joy: 0.3, anticipation: 0.3, trust: 0.3 }),
    ...
    expected_films_must_not_include: [],
    min_top10_matches: 0, // Bos input — crash olmaması yeterli
    category: 'edge_case',
  },

  {
    id: 'sprint1-d02-emoji-only',
    mood_input: '\uD83D\uDE22\uD83C\uDF27\uFE0F',
    archetype: 'Melancholy Soul',
    taste_profile: {
      emotional_state: emo({ sadness: 0.8, joy: 0.05, trust: 0.3, fear: 0.2 }),
      energy_level: 0.2,
      pace_preference: 'slow',
      visual_style: 'cinematic',
      thematic_depth: 0.7,
    ...
    expected_films_must_not_include: [],
    min_top10_matches: 0, // Emoji input — sonuc donmesi yeterli
    category: 'edge_case',
  },

  {
    id: 'sprint1-d03-single-word',
    mood_input: 'uzgunum',
    archetype: 'Melancholy Soul',
    taste_profile: {
      emotional_state: emo({ sadness: 0.85, joy: 0.05, trust: 0.3 }),
      energy_level: 0.15,
      pace_preference: 'slow',
      visual_style: 'cinematic',
      thematic_depth: 0.7,
  ...
  {
    id: 'sprint1-d04-long-input',
    mood_input: 'Yorgun bir gun gecirdim ve simdi koltukta bir film izlemek istiyorum ama cok karisik olmasin cunku konsantre olamayabilirim ayni zamanda da biraz iyi hissetmek istiyorum belki nostaljik biraz romantik ama melankolik olmasin cok da kasvetli istemem',
    archetype: 'Zen Wanderer',
    taste_profile: {
      emotional_state: emo({ joy: 0.45, trust: 0.6, sadness: 0.15, anticipation: 0.3 }),
      energy_level: 0.2,
      pace_preference: 'slow',
      visual_style: 'lush',
      thematic_depth: 0.25,
      ...
      era_preference: { from: 1990, to: 2026 },
      cultural_context: [],
      avoid_signals: ['horror', 'violence', 'war'],
      narrative_style: 'linear',
      social_context: 'alone',
      rewatch_tolerance: true,
    },
    ...
    min_top10_matches: 0, // Uzun input — timeout olmamasi ve sonuc donmesi yeterli
    category: 'edge_case',
  },

  // ═══════════════════════════════════════════════════════════════════════════
  // SPRINT 1 — KATEGORI E: NEGATIVE + FILTER (5 vaka)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'sprint1-e01-family-friendly',
    mood_input: 'ailecek izleyebilecegimiz bir film',
    archetype: 'Joy Seeker',
    taste_profile: {
  ...
  {
    id: 'sprint1-e02-short-runtime',
    mood_input: 'kisa bir film, 90 dakikadan az',
    archetype: 'Escapist',
    taste_profile: {
    ...
    // Not: runtime filtresi RPC'de yok, bu test algoritmik kaliteyi olcer
    expected_films_must_include_any_of: [
      'My Neighbor Totoro',
      'Spirited Away',
      'The Grand Budapest Hotel',
    ...
    expected_films_must_not_include: [],
    min_top10_matches: 0, // Runtime filtresi JS'te yok — sonuc donmesi yeterli
    category: 'edge_case',
  },

  {
    id: 'sprint1-e03-recent-films',
    mood_input: 'yeni bir sey, son 5 yildan',
    archetype: 'Escapist',
    taste_profile: {
  ...
  {
    id: 'sprint1-e04-english-or-turkish',
    mood_input: 'altyazi istemiyorum, Turkce veya Ingilizce olsun',
    archetype: 'Escapist',
    taste_profile: {
      emotional_state: emo({ joy: 0.4, anticipation: 0.4, trust: 0.4 }),
      energy_level: 0.5,
    ...
    // Dil filtresi RPC'de yok — sistem populer EN filmler dondurmeli
    expected_films_must_include_any_of: [
      'The Shawshank Redemption',
      'Forrest Gump',
      'Inception',
    ...
    expected_films_must_not_include: [],
    min_top10_matches: 0, // Dil filtresi yok — sonuc donmesi yeterli
    category: 'edge_case',
  },

  {
    id: 'sprint1-e05-rewatch-classic',
    mood_input: 'tekrar izlemek istedigim bir film, eskimemis',
    archetype: 'Nostalgia Keeper',
    taste_profile: {
      emotional_state: emo({ trust: 0.7, joy: 0.5, anticipation: 0.3, sadness: 0.2 }),
      energy_level: 0.4,
      pace_preference: 'medium',
      visual_style: 'cinematic',
      thematic_depth: 0.5,
      ending_preference: 'hopeful',
      era_preference: { from: 1985, to: 2020 },
      cultural_context: [],
      avoid_signals: [],
      narrative_style: 'linear',
      social_context: 'alone',
