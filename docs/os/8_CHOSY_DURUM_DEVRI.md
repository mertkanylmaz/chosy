...
| **3** | **Bible'ı repoya koy:** `docs/os/7_CHOSY_V1_KAPSAM_KILIDI.md` + Claude proje bilgisine yükle. | Hemen | 🟡 **KISMEN.** Tier 1'de tek kanonik konum kararı alındı ve dosya o yola yerleşti (bayat v1.0 kopya sorunu bitti). **Ama dosya hâlâ git'te izlenmiyor** — `git ls-files` boş döner, hiç commit edilmedi. Repoya girmesi CTO kararı bekliyor |
